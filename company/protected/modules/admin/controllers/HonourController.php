...
class HonourController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['Honour'])) {
            $model->attributes = $_POST['Honour'];

            if (empty($_POST['Honour']['name'])) {
    ...
    {
        $model=new Honour('search');
        $model->unsetAttributes();  // clear any default values
        if(isset($_GET['Honour']))
            $model->attributes=$_GET['Honour'];
    ...
    {
        $model=Honour::model()->findByPk($id);
        if($model===null)
    ...
    {
        if(isset($_POST['ajax']) && $_POST['ajax']==='honour-form')
        {
