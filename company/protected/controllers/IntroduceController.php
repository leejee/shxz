...
class IntroduceController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['Introduce'])) {
            $model->attributes = $_POST['Introduce'];

            if (empty($_POST['Introduce']['name'])) {
    ...
    {
        $model=new Introduce('search');
        $model->unsetAttributes();  // clear any default values
        if(isset($_GET['Introduce']))
            $model->attributes=$_GET['Introduce'];
    ...
    {
        $model=Introduce::model()->findByPk($id);
        if($model===null)
    ...
    {
        if(isset($_POST['ajax']) && $_POST['ajax']==='introduce-form')
        {
